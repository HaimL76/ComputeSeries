...
If $b_{11}\in{a+p^{-\beta}\mathbb{Z}_p}$, then $b_{11}=a+b$, such that $v_p(b)\geq-\beta$, which means that $v_p(b_{11})\geq\min\{v_p(a),v_p(b)\}=\min\{v_p(a),-\beta\}$.

We assumes that $v_p(a)$

$\alpha>\beta\iff-\beta>-\alpha\iff{p^{-\beta}\mathbb{Z}_p\subset{p^{-\alpha}\mathbb{Z}_p}}$.


But we assumed also $\alpha\geq-v_a\iff{v_a\geq-\alpha}$, hence $\min\{v_a,-\beta\}\geq\min\{-\alpha,-\beta\}=-\alpha$, and hence:

$b_{11}\in{a+p^{-\beta}\mathbb{Z}_p}\Rightarrow{b_{11}\in{p^{-\alpha}\mathbb{Z}_p}}$, which means that $a+p^{-\beta}\mathbb{Z}_p\subset{p^{-\alpha}\mathbb{Z}_p}$, 



but also $b_{11}\in{p^{-\alpha}\mathbb{Z}_p}$, hence $b_{11}\in{p^{-\beta}\mathbb{Z}_p}$
\end{enumerate}
\end{document}
