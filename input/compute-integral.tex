...
We compute $\mu(p^{-(v_1+v_2+v_3)}\mathbb{Z}_p\cap{[a_{11}a_{22}+p^{-(v_2+v_3+v_4)}}\mathbb{Z}_p])$, the Haar measure of the intersection.
...
Let $x\in{[a+p^{-\beta}\mathbb{Z}_p]\cap{p^{-\alpha}\mathbb{Z}_p}}$ be some element in the intersection, but if $x\in{a+p^{-\beta}\mathbb{Z}_p}$ then $x=a+b$, where $b\in{p^{-\beta}\mathbb{Z}_p}$.

Hence $v_p(b)\geq-\beta$, but then $v_p(x)\geq\min\{v_p(a),v_p(b)\}\geq\min\{v_p(a),-\beta\}$.

But $\alpha\geq-v_p(a)\iff{v_p(a)\geq-\beta}\Rightarrow\min\{v_p(a),-\beta\}\geq\min\{-\alpha,-\beta\}$,

and $\alpha\geq\beta\iff-\beta\geq-\alpha\Rightarrow{v_p(x)\geq\min\{-\alpha,-\beta\}=-\alpha}\Rightarrow{x\in{p^{-\alpha}\mathbb{Z}_p}}$.

But all this shows that $[a+p^{-\beta}\mathbb{Z}_p]\subseteq{p^{-\alpha}\mathbb{Z}_p}$, which means that 

$[a+p^{-\beta}\mathbb{Z}_p]\cap{p^{-\alpha}\mathbb{Z}_p}=[a+p^{-\beta}\mathbb{Z}_p]$.

Hence $\mu(b_{11})\geq\mu([a+p^{-\beta}\mathbb{Z}_p])=\mu(p^{-\beta}\mathbb{Z}_p)=p^{\beta}=p^{v_2+v_3+v_4}$.
...
But all this shows that $x$ cannot be both in $p^{-\alpha}\mathbb{Z}_p$ and in $[a+p^{-\beta}\mathbb{Z}_p]$, hence $p^{-\alpha}\mathbb{Z}_p\cap[a+p^{-\beta}\mathbb{Z}_p]=\phi$.
\end{enumerate}
\end{document}
