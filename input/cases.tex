...
\begin{enumerate}
\item
$v_4\overset{d}{>}v_2+v_3\overset{c}{>}v_1\overset{b}{\geq}{v_3}\overset{a}{>}v_2\overset{e}{\geq}{0}$
...
\item
$v_4\overset{d}{>}v_2+v_3\overset{c}{>}v_1\overset{b}{\geq}{v_2}\overset{a}{\geq}v_3\overset{e}{\geq}{0}$
...
\end{enumerate}
So we have $\sum_{v_{11}\geq{-v_2-v_1}}p^{\min}\mu(a_{11})=p^{v_2}(1+v_4\rho+(v_1-v_4)\rho+(v_1-v_4)v_4\rho^2+v_4\rho+v_4^2\rho^2-\frac{v_4(v_4+1)}{2}\rho^2)=p^{v_2}(1+v_4\rho+v_1\rho+v_1v_4\rho^2-\frac{v_4^2}{2}\rho^2-\frac{v_4}{2}\rho^2)$
...
$v_2\rightarrow{a+2b+c}$,
$v_3\rightarrow{b+c}$,
$v_4\rightarrow{a+b+c}$, and compute series with the new variables as indices, where $b,c,d\geq{0}$ and $a\geq{1}$
    \item
...
(v_3+v_4-v_1)\rho+(v_3+v_4-v_1)v_4\rho^2-\frac{(v_3+v_4-v_1+1)(v_3+v_4-v_1)}{2}\rho^2)=p^{v_2}(1+v_3\rho+v_4\rho-\frac{v_3^2}{2}\rho^2+v_1v_3\rho^2-\frac{v_4^2}{2}\rho^2+v_1v_4\rho^2-\frac{v_1^2}{2}\rho^2-\frac{v_3}{2}\rho^2-\frac{v_4}{2}\rho^2+\frac{v_1}{2}\rho^2)$.
...
Thus, we substitute $v_1\rightarrow{a+2b+c}$, $v_2\rightarrow{a+2b+2c+d}$, $v_3\rightarrow{b+c}$, $v_4\rightarrow{a+b+c}$, and compute series with the new variables as indices, where $b\geq{0}$ and $a,c,d\geq{1}$
    \item
...
\item $v_1\geq{v_4}>v_3>v_2\geq{0}$
    ...
    $v_1+v_2>{v_3}\geq{v_4}>v_2>v_1\geq{0}$ (3.2.4)

    \item $v_4>v_1\geq{v_2}\geq{v_3}\geq{0}$

    $v_4>v_2+v_3>{v_1}\geq{v_2}\geq{v_3}\geq{0}$ (4.1.2)
    ...
    $v_4>v_2+v_3>{v_1}\geq{v_3}>v_2\geq{0}$ (4.1.1)
...
$f(v_1,v_2,v_3,v_4)=p^{8v_1+11v_2+11v_3+7v_4}t^{4v_1+6v_2+6v_3+4v_4}$

$g(v_1,v_2,v_3,v_4)=1+v_4\rho+v_3\rho+v_3v_4\rho^2-\frac{v_3^2}{2}\rho^2-\frac{v_3}{2}\rho^2$.

$v_1\rightarrow{a+b},
v_2\rightarrow{a+b+c+d},
v_3\rightarrow{a},
v_4\rightarrow{a+b+c}$.
...
\[(fg)(a,b,c,d)=\]\[=
\frac{x_2}{(1-x_0)(1-x_1)(1-x_2)(1-x_3)}+\]
\[+\frac{2\rho{x_0}x_2}{(1-x_0)^2(1-x_1)(1-x_2)(1-x_3)}+\]
\[+\frac{\rho{x_1}x_2}{(1-x_0)(1-x_1)^2(1-x_2)(1-x_3)}+\]
\[+\frac{\rho{x_2}}{(1-x_0)(1-x_1)(1-x_2)^2(1-x_3)}+\]
\[+\frac{\rho^2(x_0^2+x_0)x_2}{2(1-x_0)^3(1-x_1)(1-x_2)(1-x_3)}+\]
\[+\frac{\rho^2{x_0}x_1x_2}{(1-x_0)^2(1-x_1)^2(1-x_2)(1-x_3)}+\]
\[+\frac{\rho^2{x_0}x_2}{(1-x_0)^2(1-x_1)(1-x_2)^2(1-x_3)}-\]
\[-\frac{\rho^2{x_0}x_2}{2(1-x_0)^2(1-x_1)(1-x_2)(1-x_3)}\]
\end{document}
